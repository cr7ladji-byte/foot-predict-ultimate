...
app = FastAPI(title="Foot Predict Ultimate")
...
<body>
    <div class="container">
        ...
        <div class="card">
            ...
            <form id="p-form">
                <div><label>Domicile</label><input type="text" id="home" placeholder="Ex: PSG, Real Madrid..." required></div>
                <div><label>Extérieur</label><input type="text" id="away" placeholder="Ex: Barcelona, Arsenal..." required></div>
                <div><label>Compétition</label><input type="text" id="comp" placeholder="Ex: Ligue 1, Champions League..."></div>
